...
int mainStaticMatch(char* imgf1 = "Images/img1.jpg", char* imgf2 = "Images/img2.jpg");
int mainKmeans(void);
...
int main(int argc, char** argv) 
{
  ...
  if ((PROCEDURE == 5) && (argc != 3)) return mainStaticMatch();
  else return mainStaticMatch(argv[1], argv[2]);
return 0;
}
...
int mainStaticMatch(char* imgf1, char* imgf2)
{
  IplImage *img1, *img2;
  img1 = cvLoadImage(imgf1);
  img2 = cvLoadImage(imgf2);
